...
CREATE TABLE IF NOT EXISTS `config_gen` (
`id_config_gen` int(11) NOT NULL,
...
`id_fournisseur` int(11) NOT NULL,
  ...
  `f_pays` int(11) NOT NULL,
  `f_tel` varchar(20) NOT NULL,
  `f_fax` varchar(20) NOT NULL,
...
`id_membre` int(11) NOT NULL,
  `m_nom` varchar(40) NOT NULL,
  `m_prenom` varchar(40) NOT NULL,
  `m_pseudo` varchar(40) NOT NULL,
